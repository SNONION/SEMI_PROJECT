...
<body>
	...
	<script>
		...
		function plusImgArea(){
			$("#img-area").append($("<img id='contentImg0' width='100' height='100' style='margin-left:20px'>"))
			$("#img-area").append($("<img id='contentImg1' width='100' height='100' style='margin-left:10px'>"))
			$("#img-area").append($("<img id='contentImg2' width='100' height='100' style='margin-left:10px'>"))
			$("#img-area").append($("<img id='contentImg3' width='100' height='100' style='margin-left:10px'>"))

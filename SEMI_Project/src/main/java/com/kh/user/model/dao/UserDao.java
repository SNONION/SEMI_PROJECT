...
public class UserDao {
	...
	public ArrayList<MyItems> selectSoldProduct(Connection con) {
		
		ArrayList<MyItems> mList = new ArrayList<>();
		
		String sql = pro.getProperty("selectSoldProduct");
		...
		try {
			...
			while(rset.next()) {
				mList.add(new MyItems(rset.getInt("PRO_NO"),
									  rset.getString("PRO_NAME"),
									  rset.getInt("PRO_COUNT")));
			}
